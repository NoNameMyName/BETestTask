...
import com.winwintravel.authapi.security.CustomUserDetails;
import com.winwintravel.authapi.security.CustomUserServiceImp;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private String getTokenFromRequest(HttpServletRequest request) {
        String bareToken = request.getHeader(HttpHeaders.AUTHORIZATION);
        if (bareToken != null && bareToken.startsWith("Bearer ")) {
            return bareToken.substring(7);
        }
        return null;
    }
}
